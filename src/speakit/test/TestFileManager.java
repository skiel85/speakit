...
public class TestFileManager extends FileManager {
	...
	public File openFile(String name) throws IOException { 
		File result=null;
		//Hago esto porque cuando piden open file 2 veces en la misma prueba, el openFile devuelve archivos distintos, pues createTempFile devuelve files con nombres al azar
