...
*Carpeta doc: aquí se pueden encontrar el manual principal, el javadoc del sistema, y archivos de ejemplo.
-El manual principal se encuentra en sus dos formatos (pdf y html). Contiene toda la informacion referida a instalación y arquitectura del proyecto.
