...
public class ArithmeticCompressorTest {
	 ...
	 private static final String VUELO_447_DE_AIR_FRANCE =
	...
	private static final String	VUELO_447_DE_AIR_FRANCE_CORTO	= "El vuelo 447 de Air France France.";
	...
	public void testCompress() throws IOException {
		//testea que el compresor genere un archivo que sea menos pesado que el original
		ByteArrayInputStream source = new ByteArrayInputStream(VUELO_447_DE_AIR_FRANCE_CORTO.getBytes());
...
//		System.out.println("Tamaño original: " + sourcebytes.length);
//		System.out.println("Tamaño comprimido: " + compressedbytes.length);
//		System.out.println("Tasa de compresión: " + 100.0*(double)compressedbytes.length/(double)sourcebytes.length + "%" );
