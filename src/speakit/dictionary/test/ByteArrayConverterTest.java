...
public class ByteArrayConverterTest {
	...
	public void testConvertToInt2() throws Exception {
		...
		Assert.assertEquals(286335781, new ByteArrayConverter().toInt(array ));
	}
	...
	public void testConvertToLong() throws Exception {
		...
		Assert.assertEquals( num, new ByteArrayConverter().toLong(array));
	}
	
	@Test
	public void testConvertToDouble() throws Exception {
		Double d = 1231.11;
		byte[] array=new ByteArrayConverter().toByta(d); 
		Assert.assertEquals( d, new ByteArrayConverter().toDouble(array));
	}
