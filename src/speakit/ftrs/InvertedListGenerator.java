...
public class InvertedListGenerator {
	...
	/**
	 * Procesa la lista de documentos, extrayendo las apariciones de cada termino
	 * basandose en el lexico existente
	 * @param documents Docs aaprocesar
	 * @param lexicon Lexico
	 */
	...
	/**
	 * Dado las apariciones registradas anteriormente, y el nro de termino definido en el lexico, 
	 * deuelve el listado de los documentos q la referencian
	 * @param termId
	 * @return
	 */
