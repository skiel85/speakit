...
public class ByteArrayConverter { 
	 ...
	 * 
	 * Codificado en big-endian, pues en el byte[0] está el byte mas significativo
	 * @param b
	 * @return
	 */ 
	public static int toInt(byte[] b, int offset) { 
		...
		return  (0xff & (b[0 + offset]))<< 24 | // XXXX XXXX|0000 0000|0000 0000|0000 0000
		 		(0xff & (b[1 + offset]))<< 16 | // 0000 0000|XXXX XXXX|0000 0000|0000 0000				
		 		(0xff & (b[2 + offset]))<< 8  | // 0000 0000|0000 0000|XXXX XXXX|0000 0000
		 		(0xff & (b[3 + offset]))<< 0  ; // 0000 0000|0000 0000|0000 0000|XXXX XXXX
