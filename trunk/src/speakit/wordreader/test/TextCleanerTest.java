...
public class TextCleanerTest {
	...
	public void testCleanText() {
		Assert.assertEquals(
			"Todo ser inteligente decía el geómetra debe comprender el destino científico de esta figura Los selenitas si existen responderán con una figura semejante y una vez establecida la comunicación fácil será crear un alfabeto que permita conversar con los habitantes de la Luna".toLowerCase(),
			this.sut.cleanText("Todo ser inteligente -decía el geómetra- debe comprender el destino científico de esta figura. Los selenitas, si existen, responderán con una figura semejante, y una vez establecida la comunicación, fácil será crear un alfabeto que permita conversar con los habitantes de la Luna")
		);
	}
